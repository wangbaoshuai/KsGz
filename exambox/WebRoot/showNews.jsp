...
<div id="main" class="l">
		...
		<div class="main-left">
			...
			<div id="art">
				...
				<h5 style="font-size: 28px;font-weight: bolder;">${findonenew.ntitle }</h5>
				...
				<img alt="" src="images/${findonenew.nimage }" width="700px;" height="400px;">
					...
					<p id="content" style="font-size: 17px;color: black;"></p>
			...
			<div class="hr" style="margin-bottom:10px;">
				...
				<s:iterator var="m" value="#attr.newList" status="num">
					<c:if test="${num.index  lt 8 }">
						<c:if test="${m.ntitle.length() >= 16 }">
						<li style="font-size: 14px"><a href="findoneNew?n.nid=${m.nid}" style="cursor:default;text-decoration:none;" title="${m.ntitle }">*${m.ntitle.substring(0,16) }...</a></li>
						</c:if>
						<c:if test="${m.ntitle.length() < 16 }">
						<li style="font-size: 14px"><a href="findoneNew?n.nid=${m.nid}">*${m.ntitle }</a></li>
						</c:if>
					</c:if>
				</s:iterator>
				</ul>
