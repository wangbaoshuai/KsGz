 ...
 <div id="main" class="l" style="width:965px; margin: 0 auto; ">
		<div class="guestbook">
			...
			<div>
						...
						<c:choose>
			          	<c:when test="${not empty findoneforum.admin  }"><img src="images/admin.jpg" style="border-radius:50%" width="85px" height="85"></c:when>
			          		<c:otherwise><img src="images/${findoneforum.student.image }" style="border-radius:50%" width="85px" height="85"></c:otherwise>
			         	 </c:choose>
          				</div>
						...
						<dl>
							...
							<br>
							<div class="timer" style="margin-left: 660px" >${findoneforum.fdate }</div>
						</dl>
			...
			<ul>
					...
					<div>
						<div style="float: left;">
						<c:choose>
			          		<c:when test="${not empty r.admin  }"><img src="images/admin.jpg" style="border-radius:50%" width="75px" height="75"></c:when>
			          		<c:otherwise><img src="images/${r.student.image }" style="border-radius:50%" width="75px" height="75"></c:otherwise>
			         	 </c:choose>
						</div>
						<div style="width:860px;float: left;margin-left: 15px">
