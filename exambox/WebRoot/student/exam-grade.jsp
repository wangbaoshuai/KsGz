						...
						<div class="page-content row">
							<div id="question-list">
								<table class="table-striped table">
									<thead>
										<tr>
											<td width="170px">科目名称</td><td width="30px">分数</td><td align="center" width="200px">时间</td><td width="80px">查看报告</td>
										</tr>
									</thead>
									<tbody>
										<c:forEach items="${gradeList}" var="grade">
											<tr>
												<td>
													${grade.subject.sname}>${grade.type }
												</td>
												<td>
													${grade.score}
												</td>
							...
							<div id="page-link-content">
								<ul class="pagination pagination-sm"><a href="javascript:check()">查看图表</a></ul>
