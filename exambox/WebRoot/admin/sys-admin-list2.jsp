  ...
  <div class="panel admin-panel">
    ...
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <li> <a class="button border-main icon-plus-square-o" href="admin/add-admin2.jsp"> 添加内容</a> </li>
        <li>
      ...
      <tr>
        ...
        <!-- <th></th> -->
     		...
     		<c:forEach items="${adminList}" var="a">
											<tr>
												<td>${a.id}</td><td>${a.aname }</td><td>${a.email}</td><td>${a.phone}</td><td>${a.power}</td><!-- <td><fmt:formatDate value="${item.create_date }" pattern="yyyy-MM-dd"/></td> -->
