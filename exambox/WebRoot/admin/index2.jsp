...
<div class="leftnav">
  ...
  <c:if test="${fn:contains(user.power,'用户管理') }">
  ...
  <c:if test="${fn:contains(user.power,'题库管理') }">
  ...
  <c:if test="${fn:contains(user.power,'科目管理') }">
  ...
  <c:if test="${fn:contains(user.power,'日期管理') }">
  ...
  <c:if test="${fn:contains(user.power,'知识点管理') }">
  ...
  <c:if test="${fn:contains(user.power,'新闻管理') }">
  ...
  <c:if test="${fn:contains(user.power,'社区管理') }">
  ...
  <ul>
    ...
    <li><a href="admin/add-forum.jsp" target="right"><span class="icon-caret-right"></span>添加帖子</a></li>          
  </ul> 
  </c:if>
  <c:if test="${fn:contains(user.power,'视频管理') }">
